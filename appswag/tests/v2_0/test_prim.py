from appswag import App, primitives, errs, io
from ..utils import get_test_data_folder
from appswag.spec.v2_0 import objects, parser
from appswag.spec import base
from appswag.utils import jp_compose
from appswag.primitives import Primitive
import os
import unittest
import datetime
import six
...
class SchemaTestCase(unittest.TestCase):
    ...
    def test_float_dump(self):
        ...
        refer to issue: https://github.com/mission-liao/appswag/issues/92
        """
...
class ParameterTestCase(unittest.TestCase):
    ...
    def test_collection_format_default(self):
        ...
        refer to issue: https://github.com/mission-liao/appswag/issues/101
        """
...
class PrimitiveExtensionTestCase(unittest.TestCase):
    ...
    def setUpClass(kls):
        ...
        def str_no_validate(obj, val, ctx):
            # same as the one used in appswag, but no validation
            return str(val)
    ...
    def test_overwrite(self):
        """ overrite type/format handler used in appswag """
        m1 = self.app.resolve('#/definitions/m1')
        v = m1._prim_({
            "job":"man"
        }, self.app.prim_factory)
